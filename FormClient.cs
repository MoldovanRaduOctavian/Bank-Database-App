    ...
    public partial class FormClient : Form
    {
        ...
        private void tabControl1_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            ...
            else if (tabControl1.SelectedTab == tabControl1.TabPages["tabPage2"])
            {
                ...
                sqc.Open();
                MySqlCommand cmd = new MySqlCommand(String.Format("SELECT detalii FROM notificari WHERE idPersoana = '{0}' AND statusNotificare = 0", idPersoana), sqc);
                MySqlDataReader read = cmd.ExecuteReader();
            ...
            else if (tabControl1.SelectedTab == tabControl1.TabPages["tabPage4"])
            {
                ...
                MySqlCommand cmd1 = new MySqlCommand(String.Format("select idDepozit, tip_depozit, dobanda, numerar from depozit where idClient = {0}", idClient), sqc);
                MySqlDataReader read = cmd1.ExecuteReader();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cmd2 = new MySqlCommand(String.Format("insert into notificari(idPersoana, detalii, statusNotificare)" +
                " values (1, '{0}', 0)", "Modificare a datelor personale"), sqc);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (ok == 1)
            {
                ...
                if (ok == 1)
                {
                    ...
                    MySqlCommand cmd5 = new MySqlCommand(String.Format("insert into notificari(idPersoana, detalii, statusNotificare) values (1, 'In asteptare transfer catre {0} in valoare de {1}', 0)", textBox8.Text, textBox9.Text), sqc);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cmd6 = new MySqlCommand(String.Format("update cont set numerar = {0} where IBAN = '{1}'", valoare_cont - valoare_factura, ContActual), sqc);
            cmd6.ExecuteNonQuery();
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            MySqlCommand cmd3 = new MySqlCommand(String.Format("update cont set numerar = {0} where IBAN = '{1}'", valoare_cont - valoare_depozit, ContActual), sqc);
            cmd3.ExecuteNonQuery();
            ...
            MySqlCommand cmd5 = new MySqlCommand(String.Format("insert into depozit(idClient, tip_depozit, dobanda, numerar) values ({0}, {1}, {2}, {3})", idClient,  tipdepozit.ToString(), valoare_dobanda, valoare_depozit), sqc);
            cmd5.ExecuteNonQuery();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cmd5 = new MySqlCommand(String.Format("update cont set numerar = {0} where IBAN = '{1}'", (valoare_cont_curent + valoare_depozit * (1 - valoare_dobanda)).
                ToString(), ContActual), sqc);
            cmd5.ExecuteNonQuery();
